...
//		xpValues.put( Blocks.GRASS.getRegistryName(), 2.5f );
		...
		xpValues.put( Blocks.DEADBUSH.getRegistryName(), 5.0f );
		xpValues.put( Blocks.WATERLILY.getRegistryName(), 15.0f );
		...
		xpValues.put( Blocks.SAPLING.getRegistryName(), 10.0f );
//		xpValues.put( Blocks.END_ROD.getRegistryName(), 25.0f );
		xpValues.put( Blocks.LEAVES.getRegistryName(), 0.8f );
		xpValues.put( Blocks.LEAVES2.getRegistryName(), 0.8f );
		xpValues.put( Blocks.PUMPKIN.getRegistryName(), 35.0f );
		xpValues.put( Blocks.MELON_BLOCK.getRegistryName(), 7.0f );
		...
		xpValues.put( Blocks.REEDS.getRegistryName(), 10.0f );
		...
		xpValues.put( Blocks.WEB.getRegistryName(), 5.0f );
		xpValues.put( Blocks.LOG.getRegistryName(), 28.0f );
		xpValues.put( Blocks.LOG2.getRegistryName(), 18.0f );
		xpValues.put( Blocks.PLANKS.getRegistryName(), 5.0f );
...
////////////////////////////////////ORE_DOUBLE_VALUES//////////////////////////////////////////////
		...
		oreDoubleValues.put( Items.DYE.getRegistryName(), 1.50f );
		
		oreDoubleValues.put( Blocks.QUARTZ_ORE.getRegistryName(), 0.55f );
...
////////////////////////////////////PLANT_DOUBLE_VALUES////////////////////////////////////////////
		...
		plantDoubleValues.put( Items.REEDS.getRegistryName(), 0.33f );
		...
		plantDoubleValues.put( Blocks.MELON_BLOCK.getRegistryName(), 0.75f );
		plantDoubleValues.put( Items.MELON.getRegistryName(), 0.75f );
		plantDoubleValues.put( Items.MELON_SEEDS.getRegistryName(), 0.75f );
		
		plantDoubleValues.put( Items.DYE.getRegistryName(), 1.50f );			// COCO
////////////////////////////////////NO_DROP_VALUES/////////////////////////////////////////////////
		noDropOres.put( Blocks.IRON_ORE.getRegistryName(), true );
		noDropOres.put( Blocks.GOLD_ORE.getRegistryName(), true );
////////////////////////////////////ORE_ITEMS_VALUES///////////////////////////////////////////////
		oreItems.put( Blocks.IRON_ORE.getRegistryName(), new ItemStack( Blocks.IRON_ORE, 0 ) );
		oreItems.put( Blocks.GOLD_ORE.getRegistryName(), new ItemStack( Blocks.GOLD_ORE, 0 ) );
		oreItems.put( Blocks.REDSTONE_ORE.getRegistryName(), new ItemStack( Items.REDSTONE, 0 ) );
		oreItems.put( Blocks.LIT_REDSTONE_ORE.getRegistryName(), new ItemStack( Items.REDSTONE, 0 ) );
		oreItems.put( Blocks.LAPIS_ORE.getRegistryName(), new ItemStack( Items.DYE, 4 ) );
		oreItems.put( Blocks.QUARTZ_ORE.getRegistryName(), new ItemStack( Items.QUARTZ, 0 ) );
		oreItems.put( Blocks.DIAMOND_ORE.getRegistryName(), new ItemStack( Items.DIAMOND, 0 ) );
		oreItems.put( Blocks.EMERALD_ORE.getRegistryName(), new ItemStack( Items.EMERALD, 0 ) );
...
////////////////////////////////////TOOL_ITEM//////////////////////////////////////////////////////
		...
		toolItems.put( Items.WOODEN_AXE.getRegistryName(), new ItemStack( Blocks.PLANKS ) );
		toolItems.put( Items.WOODEN_HOE.getRegistryName(), new ItemStack( Blocks.PLANKS ) );
		toolItems.put( Items.WOODEN_PICKAXE.getRegistryName(), new ItemStack( Blocks.PLANKS ) );
		toolItems.put( Items.WOODEN_SHOVEL.getRegistryName(), new ItemStack( Blocks.PLANKS ) );
		toolItems.put( Items.WOODEN_SWORD.getRegistryName(), new ItemStack( Blocks.PLANKS ) );
...
////////////////////////////////////SALVAGE_BASE_VALUE/////////////////////////////////////////////
		...
		salvageBaseValue.put( Blocks.PLANKS.getRegistryName(), 70.0f );
...
////////////////////////////////////SALVAGE_VALUE_PER_LEVEL////////////////////////////////////////
		...
		salvageValuePerLevel.put( Blocks.PLANKS.getRegistryName(), 0.8f );		// 25
...
//				player.setHealth( 1f );
				...
				{
					double distance = event.getEntity().getDistance( player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ() );
					if( distance > 16 )
						distance -= 16;
					else
						distance = 0;
...
//			ItemStack rItem = event.getIngredientInput();
	...
	public static NBTTagCompound getPersistTag( EntityPlayer player )
	{
		...
		{
			persistTag = playerNBT.getCompoundTag( player.PERSISTED_NBT_TAG );
		}
		return persistTag;
	}
	...
	public static NBTTagCompound getSkillsTag( NBTTagCompound persistTag )
	{
		...
		{
			skillsTag = persistTag.getCompoundTag( "skills" );	//if Player has skills tag, use it
		}
		return skillsTag;
	}

...
public enum Skill
{
    ...
    public static int getLevel( String skill, EntityPlayer player)
    {
    ...
    public static double getLevelDecimal( String skill, EntityPlayer player )
    {
        if( player.world.isRemote )
    ...
    public static double getXp( String skill, EntityPlayer player )
    {
        if( player.world.isRemote )
    ...
    public static void setLevel( String skill, EntityPlayerMP player, double amount )
    {
    ...
    public static void setXp( String skill, EntityPlayerMP player, double amount )
    {
        if( PmmoSavedData.get().setXp( skill, player.getUniqueID(), amount ) )
        {
            ...
            NetworkHandler.sendToPlayer( new MessageXp( amount, skill, 0, false ), (EntityPlayerMP) player );
        }
    }
    ...
    public static void addLevel( String skill, EntityPlayerMP player, double amount, String sourceName, boolean skip, boolean ignoreBonuses )
    {

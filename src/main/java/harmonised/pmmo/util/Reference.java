...
public class Reference {
	...
	public static final TagKey<EntityType<?>> NO_XP_DAMAGE_DEALT = TagKey.create(ForgeRegistries.ENTITY_TYPES.getRegistryKey(), new ResourceLocation(MOD_ID, "noxp_damage_dealt"));

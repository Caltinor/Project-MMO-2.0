...
public class Reference {
	...
	public static final TagKey<Block> CASCADING_BREAKABLES = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(MOD_ID, "cascading_breakables"));
	public static final TagKey<Block> MINABLE_AXE = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("mineable/axe"));
	public static final TagKey<Block> MINABLE_HOE = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("mineable/hoe"));
	public static final TagKey<Block> MINABLE_SHOVEL = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("mineable/shovel"));

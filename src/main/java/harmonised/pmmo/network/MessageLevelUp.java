                            ...
                            for( ServerPlayerEntity otherPlayer : players )
                            {
                                if( otherPlayer.getUniqueID() != player.getUniqueID() )
                                {
                                    ...
                                    if( totalLevelMilestone )
                                        otherPlayer.sendStatusMessage( new TranslationTextComponent( "pmmo.milestoneTotalLevel", player.getDisplayName(), totalLevel ).setStyle( XP.textStyle.get( "green" ) ), false );
                                }
                            };
                        }
                    }

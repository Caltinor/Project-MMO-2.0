...
//						player.sendStatusMessage( new StringTextComponent( args[0] + " has been set to level: " + newXp ), false );
//					}
//					else if( newXp >= 0 && newXp <= 2000000000 )
//					{
//						XP.setXp( player, args[0], newXp );
//						player.sendStatusMessage( new StringTextComponent( args[0] + " has been set to: " + args[1] + "xp" ), false );
//					}
//					else
...
//				}
//				else
//					player.sendStatusMessage( new StringTextComponent( "You must specify an amount!" ), false);
//			}
//			else
//				player.sendStatusMessage( new StringTextComponent( "\"" + args[0] + "\" is not a valid skill!" ), false);
//		}
//		else
//			player.sendStatusMessage( new StringTextComponent( "You must specify a skill!" ), false);
//	}
}

...
public record LocationData(
	...
	public static final Codec<LocationData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Codec.unboundedMap(ResourceLocation.CODEC, CodecTypes.DOUBLE_CODEC).optionalFieldOf("mob_multiplier").forGetter(ld -> Optional.of(ld.mobModifiers()))
	...
	public static class Builder {
        ...
        public Builder isTagFor(Set<String> tags) {this.tagValues = tags; return this;}
        ...
        public LocationData build() {
            return new LocationData(override, tagValues, bonusMap, positive, negative, veinBlacklist, travelReq, mobModifiers);
        }
    }
}

...
public class ClientSetup {
	...
	public static final KeyMapping SHOW_VEIN = new KeyMapping(LangProvider.KEYBIND_SHOWVEIN.key(), 43 /*tab*/, CATEGORY);
	public static final KeyMapping ADD_VEIN = new KeyMapping(LangProvider.KEYBIND_ADDVEIN.key(), 47 /*left brace*/, CATEGORY);
	public static final KeyMapping SUB_VEIN = new KeyMapping(LangProvider.KEYBIND_SUBVEIN.key(), 48 /*right brace*/, CATEGORY);
	public static final KeyMapping CYCLE_VEIN = new KeyMapping(LangProvider.KEYBIND_VEINCYCLE.key(), 52 /*apostrophe*/, CATEGORY);
    public static final KeyMapping SHOW_LIST = new KeyMapping(LangProvider.KEYBIND_SHOWLIST.key(), 226 /*left alt*/, CATEGORY);
    public static final KeyMapping VEIN_KEY = new KeyMapping(LangProvider.KEYBIND_VEIN.key(), 53 /*grave accent*/, CATEGORY);
    public static final KeyMapping OPEN_MENU = new KeyMapping(LangProvider.KEYBIND_OPENMENU.key(), 19 /*P*/, CATEGORY);
	public static final KeyMapping TOGGLE_BRKSPD = new KeyMapping(LangProvider.KEYBIND_TOGGLE_BRKSPD.key(), 45 /*minus*/, CATEGORY);

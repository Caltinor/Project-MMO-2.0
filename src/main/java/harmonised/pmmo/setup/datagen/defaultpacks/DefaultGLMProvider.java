...
public class DefaultGLMProvider extends GLMProvider {
    ...
    protected void start() {
        ...
        //===========RARE MOB DROPS==================
        add("mob_chicken", mob(EntityTypes.CHICKEN, Items.EGG, 1, 0.1, "combat", 33));
        add("mob_dragon_head", mob(EntityTypes.ENDER_DRAGON, Items.DRAGON_HEAD, 1, 1.0, "combat", 1500));
        add("mob_dragon_egg", mob(EntityTypes.ENDER_DRAGON, Items.DRAGON_EGG, 1, 1.0, "combat", 1500));
        add("mob_sheep", mob(EntityTypes.SHEEP, Items.STRING, 1, 0.1, "farming", 33));
        add("mob_slime", mob(EntityTypes.SLIME, Items.SLIME_BLOCK, 1, 1, "combat", 100));
        add("mob_zombie", mob(EntityTypes.ZOMBIE, Items.BEETROOT, 1, 0.4, "combat", 67));
    }
}

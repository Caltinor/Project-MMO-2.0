...
//    }
    ...
    public static void addXpMapEntryAsText( List<ITextComponent> text, Map<String, Double> xpBoosts )
    {
        ...
        for( Map.Entry<String, Double> entry : xpBoosts.entrySet() )
        {
            ...
            skill = new TranslationTextComponent( "pmmo." + skill.toString() ).getString();
    ...
    protected void init()
    {
        ...
        text.add( new TranslationTextComponent( "pmmo.heartBonus", AttributeHandler.getHeartBoost( player ) ).setStyle( Skill.getSkillStyle( Skill.ENDURANCE.toString() ) ) );
        statsEntries.add( new StatsEntry( 0, 0, entryTitle, text ) );
...
//        text.add( new TranslationTextComponent( "pmmo.respirationBonus", getRespirationBonus( player ) ).setStyle( Skill.getSkillStyle( Skill.SWIMMING ) ) );
//        statsEntries.add( new StatsEntry( 0, 0, entryTitle, text ) );

            ...
            if( prefEntry.getY() + prefEntry.getHeight() > this.top && prefEntry.getY() - prefEntry.getHeight() < this.bottom )
            {
                if( prefEntry.isSwitch )
                {
                    if( slider.getValue() == 1 )
                        drawGradientRect(this.left + 4, prefEntry.getY() - 11, this.right - 2, prefEntry.getY() + slider.height + 2, 0x22444444, 0x33222222);
                    else
                        drawGradientRect(this.left + 4, prefEntry.getY() - 11, this.right - 2, prefEntry.getY() + slider.height + 2, 0xaa444444, 0xaa222222);
                }
                else
                {
                ...
                drawCenteredString( fontRenderer, prefEntry.preference, prefEntry.getX() + slider.getButtonWidth() / 2, prefEntry.getY() - 9, 0xffffff );
                slider.drawButton( mc, mouseX, mouseY, 0 );

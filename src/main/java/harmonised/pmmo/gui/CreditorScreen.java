...
//        }
    ...
    {
        uuidName.setTag( "e4c7e475-c1ff-4f94-956c-ac5be02ce04a", "Lucifer#0666" );
        uuidName.setTag( "8eb0578d-c113-49d3-abf6-a6d36f6d1116", "Tyrius#0842" );
        uuidName.setTag( "2ea5efa1-756b-4c9e-9605-7f53830d6cfa", "didis54#5815" );
        uuidName.setTag( "0bc51f06-9906-41ea-9fb4-7e9be169c980", "stressindicator#8819" );
        uuidName.setTag( "5bfdb948-7b66-476a-aefe-d45e4778fb2d", "Daddy_P1G#0432" );
        uuidName.setTag( "554b53b8-d0fa-409e-ab87-2a34bf83e506", "joerkig#1337" );
        List<String> list;

        /////////LAPIS//////////////
        PlayerConnectedHandler.lapisPatreons.forEach( a ->
        {
            colors.setTag( uuidName.get( a.toString() ), 0x5555ff );
            creditorsInfo.setTag( uuidName.get( a.toString() ), new ArrayList<>());
        });
        //LUCIFER
        ...
        {
            colors.setTag( uuidName.get( a.toString() ), 0xffff33 );
            creditorsInfo.setTag( uuidName.get( a.toString() ), new ArrayList<>());
        });
        ...
        {
            colors.setTag( uuidName.get( a.toString() ), 0xeeeeee );
            creditorsInfo.setTag( uuidName.get( a.toString() ), new ArrayList<>());
        } );
        //DIDIS54
        ...
        creditorsInfo.setTag( "TorukM4kt00#0246", list );
        //Dawnless#1153
        list = new ArrayList<>();
        ...
        creditorsInfo.setTag( "Dawnless#1153", list );
        //TorukM4kt00#0246
        list = new ArrayList<>();
        list.add( new TextComponentTranslation( "pmmo.discordMemberSince", "13/05/2020" ).getUnformattedText() );
        list.add( new TextComponentTranslation( "pmmo.translated", "Portuguese - Brazil" ).getUnformattedText() );
        ...
        creditorsInfo.setTag( "starche#7569", list );
        //Lyla#2639
        list = new ArrayList<>();
        ...
        creditorsInfo.setTag( "Lyla#2639", list );
    }
}
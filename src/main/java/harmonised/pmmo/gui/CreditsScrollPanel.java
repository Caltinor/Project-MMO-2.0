...
public class CreditsScrollPanel extends GuiScreen
{
    ...
    public CreditsScrollPanel( Minecraft client, int width, int height, int top, int left, JType jType, ArrayList<ListButtonBig> buttons )
    {
        super();
        this.jType = jType;
...
//import java.util.List;
//
//public class CreditsScrollPanel extends PmmoScrollPanel
//{

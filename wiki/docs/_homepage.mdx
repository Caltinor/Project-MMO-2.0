...
<Asset location="pmmo:feature_packs" width="50%"/>
<Callout>If you added Project MMO to an existing world, the "Default Project MMO Pack" will be enabled.</Callout>
...
- Scripting: a simplified code-like format which uses text-based `.pmmo` files in the `config/` folder.mod
...
[Read More About Configuring Project MMO](docs/configuration/config_home)
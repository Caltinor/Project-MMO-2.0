...
WITH config(server)
    ...
    set(mob_scale_base_level).value(0);
    set(boss_scaling).value(1.1);
    set(use_exponential_formula).value(true);
    set(mob_scale_per_level).value(1.0);
    set(mob_scale_power_base).value(1.104088404342588);
...
```json
{
  ...
  "mob_scaling": {
    ...
    "mob_scale_per_level": 1.0,
    "mob_scale_power_base": 1.104088404342588,
    "ratios": {
...
|        `xp_per_level`        | sets the value of the same name in the formula `xp_min + xp_base^(level * per_level)`                                                                    |                                                                                                                                                                                                                   | decimal vale. default `value(1.1)`                                                                                                                                                                                             |
...
|       `mob_scale_base_level`        | the minimum level in the skill a player must be to contribute to scaling                                                                                 |                                                                                                                                                                                                                   | whole number. defaule `value(0)`                                                                                                                                                                                               |
...
|        `mob_scale_per_level`        | the value in the formulas for linear (`(playerLevels - base_level) * per_level`) or exponential (`power_base^(per_level * (playerLevels - base_level))`) |                                                                                                                                                                                                                   | decimal number. default `value(1.0)`                                                                                                                                                                                           |
|       `mob_scale_power_base`        | see above                                                                                                                                                |                                                                                                                                                                                                                   | decimal value. default `value(1.104088404342588)`                                                                                                                                                                              |

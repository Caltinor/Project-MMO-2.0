...
|       `req`       | req name in all uppercase letters.  EG. KILL, BREAK, TRAVEL                   | keyword = `require`. the skills and experience separated by commas.  `skill,1`  for multiple skills continue the pattern `requires(skill,1,otherskill,10)`. [possible events](https://github.com/SomewhatDamaged/Project-MMO-2.0/blob/patch-14/wiki/docs/core/events.mdx)                                                                                                      |

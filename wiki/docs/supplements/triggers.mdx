# Advancement Triggers and FTB Quests compatibility
Project MMO provides one advancement trigger which can be used in the vanilla advancement system to award advancments when the player levels up skills.

<Callout>
    FTB Quests at the bottom of the page
</Callout>
...
This criteria requires the player to be level 3 in agility to trigger. For more information on creating advancements refer to [The Minecraft Wiki](https://minecraft.wiki/w/Advancement_definition). There is also [this](https://misode.github.io/advancement/) tool that will do a lot of the setup for you for all your datapack needs, advancements included.
...
# FTB Quests
Project MMO also provides tasks and rewards integration with FTB Quests.
<Asset location="pmmo:ftbq_quest_sample" width="50%"/>
### Tasks
- Reach X Skill level
<Asset location="pmmo:ftbq_tasks" width="25%"/>
### Rewards
- Skill Level Reward
- Skill raw XP Reward
<Asset location="pmmo:ftbq_rewards" width="25%"/>